...
try:
    ...
    from transformers.utils import is_torch_xpu_available as _is_torch_xpu_available
    from transformers.utils import is_torchdynamo_compiling

    IS_TORCH_XPU_AVAILABLE = _is_torch_xpu_available()
except ImportError:
...
def _ignore_causal_mask_sdpa(
    ...
    if (
        ...
        and (
            ...
            or (padding_mask.all() if not IS_TORCH_XPU_AVAILABLE or query_length == 1 else padding_mask[:, :query_length].all())
        )
    ):
        return True
